const werkstatt = [
  ...
  },
  {
    ...
    summary: 'Alle veröffentlichten Sonntagsfrage-Umfragen seit 2019, zusammengeführt zu einem geglätteten Trend — und darunter: House-Effects, Wahlgenauigkeit, Reaktionsgeschwindigkeit (zwei Methoden), und Bundesländer-Analyse.',
    sources: [
      { name: 'DAWUM', url: 'https://dawum.de', license: 'ODbL (mit Quellenangabe)' },
      { name: 'wahlrecht.de', url: 'https://www.wahlrecht.de/umfragen/', license: 'frei nutzbar' },
    ],
    steps: [
    ...
    caveats: [
      'Die House-Effects-Analyse misst Abweichungen vom Instituts-Konsens — nicht von der Wahrheit. Ob der Konsens stimmt, zeigen erst Wahlergebnisse.',
      'Der Konsens ist kein unabhängiger Maßstab. Wenn alle Institute ähnliche Methoden oder Stichprobenrahmen haben und sich gemeinsam irren, sieht das in dieser Analyse wie Konsens aus.',
      'Für BSW sind alle Stichproben kleiner (Partei erst seit 2024). Frühe Werte aus der Gründungsphase können verzerren.',
      'Die Wahlgenauigkeits-Daten für 2017 enthalten keine genauen Umfragedaten — nur die Abweichungen sind bekannt. 2005, 2009, 2013 fehlen aus Quellenmangel ganz.',
      'Die Cross-Korrelations-Lead/Lag-Analyse ist explorativ: die meisten Korrelationen sind schwach (r < 0.5). Ausgefüllte Punkte = r ≥ 0.3 und n ≥ 20 Wochen — das ist kein Beweis, nur ein Hinweis.',
      'Die Threshold-Crossing-Analyse bevorzugt strukturell Institute, die häufiger publizieren (z.B. Forsa, INSA). Diese erscheinen "früher", weil der Gesamt-Konsens ihr Signal bereits einschließt und dadurch verlangsamt wird. Die Messung erfasst Frequenz und Reaktionszeit zusammen, nicht getrennt.',
      'Bundesländer-Daten sind deutlich dünner. Viele Zellen haben n < 10. Abweichungen können auf einzelne Wahlkampf-Perioden zurückgehen statt auf systematische Effekte.',
      'Die Trendlinie ist nicht House-Effect-bereinigt. Ein Modell, das die Schlagseiten herausrechnet und einen Unsicherheitskorridor ausgibt, wäre der nächste methodische Schritt.',
    ],
  },
  {
  ...
  },
  {
    ...
    steps: [
      ...
      'Parallel dazu, aus derselben Pipeline: dieselbe Keyword-Zählung noch einmal nach Fraktion statt Bundesland gruppiert (StateParl liefert die Fraktionszugehörigkeit je Redeabschnitt), auf 8 Fraktionen eingedampft und als Heatmap (Thema × Partei, zeilenweise normiert) dargestellt.',
    ],
    caveats: [
      ...
      'Die Partei-Heatmap zeigt 8 von rund 30 Fraktionscodes (kleine/historische Parteien und die Regierungsbank ausgeblendet) und vergleicht Parteien über unterschiedlich lange aktive Zeiträume — AfD und BSW erst ab ihrem jeweiligen Landtagseinzug, ältere Parteien über die vollen 26 Jahre.',
    ],
  },
  {
